...
left = cv2.imread("/Users/nannan/PycharmProjects/MVGlab04_stereo-rectify-and-disparity-estimation/p4/tsukuba/tsukuba_l.png", 0)
right = cv2.imread("/Users/nannan/PycharmProjects/MVGlab04_stereo-rectify-and-disparity-estimation/p4/tsukuba/tsukuba_r.png", 0)

# left = cv2.imread("/Users/nannan/PycharmProjects/StereoReconstruct/data/tsukuba_l.png", 0)
# right = cv2.imread("/Users/nannan/PycharmProjects/StereoReconstruct/data/tsukuba_r.png", 0)
...
cv2.imwrite("/Users/nannan/PycharmProjects/StereoReconstruct/my_out/Disparity_dynamic.png", final_img)
